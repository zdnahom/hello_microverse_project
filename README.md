...
**Hello Microverse** is a simple project which displays "Hello Microverse"
...
- **Displays "Hello Microverse" in a beatiful style**
...
git clone https://github.com/zdnahom/hello_microverse_project.git
...
To run the project, execute the following command:
  ...
  - start live server
  - go to Localhost/hello_microverse/index.html
